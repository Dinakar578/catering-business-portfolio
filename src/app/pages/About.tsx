...
import chefImage from "/src/assets/img3.jpeg";
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
            ...
            <div className="flex justify-center items-end h-full -ml-10">
  <img
    src={chefImage}
    alt="Chef"
    className="h-[500px] object-contain rounded-xl shadow-lg"
  />
</div>
          </div>
        </div>
