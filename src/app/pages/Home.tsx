...
import  chefImage  from "/src/assets/img2.png";
...
export function Home() {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="relative min-h-[650px] md:h-[600px] flex items-center overflow-hidden">
        {/* Background */}
        <div className="absolute inset-0 bg-gradient-to-r from-black/85 to-black/45 z-10"></div>

        <ImageWithFallback
          src="https://images.unsplash.com/photo-1560117531-2304cfbbe9f6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg"
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-10">
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6 md:gap-8">
            ...
            <div className="text-white text-center md:text-left">
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 bg-primary hover:bg-red-700 text-white px-7 py-4 rounded-lg transition-all shadow-lg hover:shadow-xl hover:scale-105 font-semibold"
              >
                Book Now
            ...
            <div className="flex justify-center md:justify-end items-end">
              <img
                src={chefImage}
                alt="Chef"
                className="h-[330px] sm:h-[420px] md:h-[700px] object-contain drop-shadow-2xl"
              />
            </div>
