...
import chefImage from "/src/assets/img1.jpeg";
...
export function Gallery() {
  ...
  const galleryImages = [
    ...
    {
      url: "https://images.unsplash.com/photo-1599043513900-ed6fe01d3833?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkaW5kaWd1bCUyMGJpcnlhbmklMjB0YW1pbCUyMHNwaWN5fGVufDF8fHx8MTc3NTgyODE1M3ww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
      alt: "Chicken Biryani",
      category: "Biryani Specials",
    },
    {
  ...
  return (
    <div>
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-primary to-red-700 text-white py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Our Gallery</h1>
